                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name=" status" id="stkr" class="form-control">
                                                                            ...
                                                                            <?php if ($this->session->userdata('role_id') == 1) { ?>
                                                                                <option value="0" <?= $r->status == '0' ? 'selected' : '' ?>>Menunggu Konfirmasi</option>
                                                                                <option value="0" <?= $r->status == '3' ? 'selected' : '' ?>>Menunggu Dikirim</option>
                                                                            ...
                                                                            <?php } ?>
                                                                            <?php if ($this->session->userdata('role_id') == 3) { ?>
                                                                                <option value="1" <?= $r->status == '1' ? 'selected' : '' ?>>Stock Habis</option>
                                                                                <option value="2" <?= $r->status == '2' ? 'selected' : '' ?>>Dikonfirmasi</option>
                                                                                <option value="4" <?= $r->status == '4' ? 'selected' : '' ?>>Dikirim</option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                      <?php } else if ($this->session->userdata('role_id') == 1 && $r->status == 1) { ?>
                                                                          <div class="form-group">
                                                                              <label for="stkr""><b>Konfirmasi Request</b></label>
                                                                            <select name=" status" id="stkr" class="form-control">
                                                                                  <option value="">-- PILIH KONFIRMASI REQUEST --</option>
                                                                          ...
                                                                          <div class="form-group">
                                                                              ...
                                                                              <select name="id_pemasok" id="" class="form-control">
                                                                                  ...
                                                                                  <?php foreach ($pemasok as $pp) { ?>
                                                                                      <option value="<?= $pp->id_produk ?>" <?= $pp->id_produk == $r->id_produk ? 'selected' : '' ?>><?= $pp->nama_pemasok ?></option>
                                                                                  <?php } ?>
                                                                              </select>
                                                                          </div>
                                                                          <div class="form-group">
                                              ...
                                              <td>
                                                  <?php
                                                    ...
                                                    if ($r->status == 0) {
                                                        ...
                                                        echo '<span class="badge badge-dark">Stock Kosong</span>';
                                                    } else if ($r->status == 2) {
                          ...
                          <div class="row">
                              <div class="col-lg-12">
                                  <form action="<?= base_url('tambah-request-produk') ?>" method="post" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                          <label for="">Data Supplier</label>
                                          <select name="id_pemasok" id="" class="form-control">
                                              <option value="" selected disabled>-- PILIH SUPPLIER --</option>
                                              <?php foreach ($pemasok as $pp) { ?>
                                                  <option value="<?= $pp->id_produk ?>"><?= $pp->nama_pemasok ?></option>
                                              <?php } ?>
                                          </select>
                                      </div>
                                      <div class="form-group">
